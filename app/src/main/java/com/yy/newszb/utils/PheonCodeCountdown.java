 ...
 *
 */
public class PheonCodeCountdown extends CountDownTimer {
    ...
    public PheonCodeCountdown( Activity mActivity,long millisInFuture, long countDownInterval,Button btn) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
        btn.setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.shape_login_messgae_but1));
    ...
    public void onFinish() {
        ...
        btn.setBackgroundDrawable(mActivity.getResources().getDrawable(R.drawable.shape_my_out_login_but));//还原背景色
