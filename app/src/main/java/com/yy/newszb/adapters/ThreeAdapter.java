...
public class ThreeAdapter extends BaseAdapter{
    ...
    private List<ThreeEntity> data;

    private Context content;

    private LayoutInflater inflater;

    public ThreeAdapter(List<ThreeEntity> data,Context content) {
        this.data = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ThreeAdapter.ViewHolder vh = null;

        if(convertView == null){

            vh = new ThreeAdapter.ViewHolder();
            ...
            vh = (ThreeAdapter.ViewHolder)convertView.getTag();

        }

        ThreeEntity te = data.get(position);
